module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        const newsTitle = ["上官婉儿·梁祝 爆料! 越剧女小生登场", "【王者荣耀】带你1分钟邂逅越剧", "网络跳红460？试试腾讯手游加速器", "四周岁庆典爆料⑦ | 英雄新形象！局外展示大升级~", "四周岁庆典爆料⑥ | 信誉系统再升级，对局数据更清晰！", "10月12日抢先服不停机更新公告", "10月10日正式服不停机更新公告", "10月9日抢先服不停机更新公告", "10月8日【抢先服】“四周岁特别版本”更新公告", "净化游戏环境声明及处罚公告（9月27日-10月13日）", "抢先服更新 新赛季来袭", "限定皮肤返场投票开启公告及FAQ", "峡谷最强战队争霸赛落幕，冠军诞生！", "乐享小长假 永久皮肤等你拿", "千灯会活动开启 参与必得四周岁专属回城特效", "【KPL今日预报】RNG.M vs QGhappy，抢分大战进行时", "你是赛评师：AG超玩会创造本赛季最短交战记录，他们有望终结eStar连胜吗？", "天秀之人你不知道的逃生冷知识：被五个大汉追你想怎么跑？", "高校联赛榜单活动超嗨来袭！电竞热血等待燃烧！", "嘴强王者：为什么KPL赛场的天秀英雄，路人局却鲜有出场？"]
    ...
    router.get('/news/list', async (req, res) => {
        ...
        const cats = await Category.aggregate([
            ...
            // 只获取5条数据
            {
                // $addFields添加字段
                $addFields: {
                    // 选择newsList使用￥slice选择$newsList的五条数据
